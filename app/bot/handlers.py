...
async def process_feedback_step(message):
    ...
    prompt_tail = f"\n\nReply with /reply {user_id} <message> to respond."
...
async def handler_broadcast_content(message):
    ...
    # Send clean preview (exactly what users will see)
